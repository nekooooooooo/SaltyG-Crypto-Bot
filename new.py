...
def getSymbolsJson():
    ...
    print("Getting Symbos...")

    for i in range(len(data)):
        coins[f"{data[i]['symbol']}"] = f"{data[i]['id']}"
...
def cryptoConverter(crypto):
    return symbolsDict.get(crypto, crypto)
